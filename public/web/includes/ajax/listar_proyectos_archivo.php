...
if(!permiso('admin')){
if(!permiso('proyectos')){
$nestedData[] = '
<a class="i-dt-list" href="proyecto.php?id='.$row['idobras'].'" data-toggle="tooltip" title="Ver informe"><i class="mdi mdi-information-variant"></i></a>
<a class="i-dt-list" href="includes/windows/imprimir_informe_proyecto.php?id='.$row['idobras'].'" data-toggle="tooltip" title="Imprimir" target="_blank" onclick="window.open(this.href, this.target, "width=600,height=500"); return false;"><i class="mdi mdi-printer"></i></a>';
}
...
<a class="i-dt-list" href="proyecto.php?id='.$row['idobras'].'" data-toggle="tooltip" title="Ver informe"><i class="mdi mdi-information-variant"></i></a>
<a class="i-dt-list" href="includes/windows/imprimir_informe_proyecto.php?id='.$row['idobras'].'" data-toggle="tooltip" title="Imprimir" target="_blank" onclick="window.open(this.href, this.target, "width=600,height=500"); return false;"><i class="mdi mdi-printer"></i></a>
<a class="i-dt-list" href="includes/functions/restaurar.php?id='.$row['idobras'].'&url=archivo-proyectos&tipo=proyecto" data-toggle="tooltip" title="Restaurar"><i class="mdi mdi-backup-restore"></i></a>';
}
}
if(permiso('admin')){
$nestedData[] = '
