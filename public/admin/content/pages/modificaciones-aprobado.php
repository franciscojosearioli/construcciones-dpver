...
<div class="card-body">
            <div class="table-responsive">
              <table id="lista_modificaciones_aprobado" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th class="w-5"></th>
                    ...
                    <th class="text-center"> Computo </th>
