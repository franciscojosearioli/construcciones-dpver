...
<form method="post">
<div class="row">
<div class="col-12"><label>Para consultar un flujo de obra debe ingresar titulo de la obra, numero del expediente, contratista adjudicado o ubicacion y luego seleccione la opcion</label>
...
<div id="flujo-obras"></div>
<script>

function resultadoobra(id){
  var id = id;
  $('#listar-obras').hide();
  $.post("content/forms/flujo-obra.php", {obra_id: id}, function(result){
    $("#flujo-obras").html(result);
  });
}
...
<script type="text/javascript" src="includes/ajax/scripts/flujo-obras.js"></script>
<?php 
pie(); ?>
