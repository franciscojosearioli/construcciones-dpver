...
$user = current_user();
$obras_construcciones = obras_neutralizadas_activas($user['iddireccion'],$user['iddepartamentos']);
cabecera('Obras neutralizadas');
?>
<div class="row">
  <div class="col-lg-12">
        ...
        <div class="row">
          <div class="col-12">
            <div class="d-flex flex-wrap margin-dt">
              <div>
                <h3 class="card-title">Listado de obras neutralizadas</h3>
