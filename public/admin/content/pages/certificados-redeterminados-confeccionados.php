...
?>
<div class="p-20" id="crc">
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="row">
              <div class="col-12">
      <div class="table-responsive">
       <table id="cert-confeccionados" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%"
       >
        <thead>
          <tr>
            <th></th>
...
$('#cert-confeccionados').DataTable({  
             ajax: {
          url : 'includes/ajax/listar_certificados_confeccionados.php',
          type: 'POST'
        },     
  ...
  var estado = estado;
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#cc').load('certificados-confeccionados');
            }
        });
}
