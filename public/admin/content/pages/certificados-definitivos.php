...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12">
      ...
      <div class="table-responsive">
       <table id="cert-definitivos" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%"
       >
        <thead>
          <tr>
            <th></th>
...
$('#cert-definitivos').DataTable({  
             ajax: {
          url : 'includes/ajax/listar_certificados_definitivos.php',
          type: 'POST'
        },     
