...
cabecera('Contrataciones');
$user = current_user();
 ?>
         <div class="row justify-content-center" id="listar_contrataciones">
        <div class="col-8">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap margin-dt">
                                            <div>
                                                <h3 class="card-title">Listado de contratos registrados</h3>
      ...
      <div class="table-responsive">
              <table id="tabla_contrataciones" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    <th> </th>
...
<script type="text/javascript" src="includes/ajax/scripts/contrataciones.js"></script>
<?php 
require_once('../forms/agregar_contrato.php');
pie(); 
?>