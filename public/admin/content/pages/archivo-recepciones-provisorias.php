...
cabecera('Recepciones provisorias archivadas');
$user = current_user();
$recepciones_provisorias_construcciones = recepciones_provisorias_construcciones_archivo();
$conteo_recepciones_provisorias = conteo_recepciones_provisorias_archivo('recepciones_provisorias','idrecepciones_provisorias');
...
?>
            ...
            <div class="card-body">
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap margin-dt">
                                            <div>
                                                <h3 class="card-title">Listado de recepciones provisorias (Archivo)</h3>
      ...
      <div class="table-responsive">
                <table id="all" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <?php foreach ($recepciones_provisorias_construcciones as $recepcion):
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php if(permiso('admin') || permiso('recepciones')){ ?>
                            ...
                            <a class="i-dt-list" href="includes/functions/restaurar.php?id=<?php echo (int)$recepcion['idrecepciones_provisorias'];?>&url=archivo-recepciones-provisorias&tipo=recepcion-provisoria" data-toggle="tooltip" title="Restaurar"><i class="mdi mdi-backup-restore"></i></a>
                          <?php } ?>
                        </td>
