  ...
  <div class="col-lg-12 col-md-12 col-sm-12">
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap margin-dt">
                                            <div>
                                                <h3 class="card-title">Listado de certificados emitidos por le dpto certificaciones y costos</h3>
      ...
      <div class="table-responsive">
       <table id="cert-emitidos" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%"
       >
        <thead>
          <tr>
            <th></th>
...
$(document).ready(function() {
        $('#cert-emitidos').DataTable({
             dom: 'lBfrtip',   
             ajax: {
          url : 'includes/ajax/listar_certificados_emitidos.php',
          type: 'POST'
        },     
        buttons: [
        {
