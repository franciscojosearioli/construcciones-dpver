...
cabecera('Obras archivadas');
$user = current_user();
$obras_construcciones_archivo = obras_construcciones_archivo($user['iddireccion'],$user['iddepartamentos']);
?>
      <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card-body">
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap margin-dt">
                                            <div>
                                                <h3 class="card-title">Listado de obras archivadas</h3>
      ...
      <div class="table-responsive">
              ...
              <?php }else{ ?>
                ...
                <?php } ?>
                  ...
                  <tbody>
              <?php foreach ($obras_construcciones_archivo as $obra):
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <?php if(permiso('admin') || permiso('obras')){ ?>
                      <a class="i-dt-list" href="includes/functions/restaurar.php?id=<?php echo (int)$obra['idobras'];?>&url=archivo-obras&tipo=obra" data-toggle="tooltip" title="Restaurar" style="color:#1e88e5"><i class="mdi mdi-close"></i></a>
                    <?php } ?>
                  ...
                  <td>
                    ...
                    <?php if(permiso('admin')){ 
                      if(!empty($obra['alias'])){ echo ifexist($obra['alias']); 
                    }else{ echo ifexist($obra['nombre']); }  }else{ echo ifexist($obra['alias']); } ?></td>
