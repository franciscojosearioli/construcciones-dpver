<?php $obra_neutralizaciones = obra_neutralizaciones((int)$_GET['id']); ?>
<div class="modal fade" id="neutralizaciones" tabindex="-1" role="dialog" aria-labelledby="neutralizaciones" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title w-100" id="neutralizaciones">Neutralizaciones de obra</h4>
        ...
        <div class="modal-body">
          <div class="form-group p-20">
            <div class="row p-20 justify-content-center">       
              <h5><b>NEUTRALIZACIONES DE OBRA </b></h5>
            </div>     
            <?php foreach($obra_neutralizaciones as $obra): ?>                   
            ...
            <input type="text" name="idneutralizaciones[]" value="<?php echo $obra['idneutralizaciones'];?>" hidden>
            <div class="row p-t-20">
              <div class="col-md-3">
                <div class="md-form form-md">
                  <label class="control-label">Numero</label>
                  <input type="text" name="numero[]" class="form-control" value="<?php echo $obra['numero'];?>">
                  <small class="form-control-feedback"> Neutralizacion </small>
                </div>
              </div>  
              <div class="col-md-4">
                <div class="md-form form-md">
            ...
            <div class="row p-t-20">
              <div class="col-md-12">
                <div class="md-form">
                  <label class="control-label">Fecha de neutralizacion</label> 
            ...
            <div class="row p-t-20">
              <div class="col-md-12">
                <div class="md-form">
                  ...
                  <small class="form-control-feedback"> Descripcion de la neutralizacion </small> 
                </div>
              </div>                        
            </div>
            <hr>  
            <?php endforeach; ?>  
<div id="AddNeutralizaciones"></div>
<input class="btn btn-success" type="button" id="AddBotonNeutralizacion" value="Agregar Mas" onClick="AgregarNeutralizacion();" />

          </div> 
        </div>
          <div class="modal-footer">
            <button type="submit" name="neutralizaciones" class="btn btn-info waves-effect waves-light">Guardar cambios</button>
          </div>
        </form>      
      </div>
    </div>
