...
<div class="modal fade" id="add_notas_de_pedido" tabindex="-1" role="dialog" aria-labelledby="add_notas_de_pedido" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title w-100" id="add_notas_de_pedido">Cargar nuevo documento</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="obra.php?id=<?php echo $obra['idobras']; ?>" name="form_notas_de_pedido" method="post" enctype="multipart/form-data">
      <div class="modal-body">
          <div class="card-body">
            <div class="row justify-content-center">          
           <h5 class="p-b-20"><b>NOTA DE PEDIDO</b></h5>
            <div class="row justify-content-center">
        ...
        <div class="modal-footer">
          <button type="submit" name="add_notas_de_pedido" class="btn btn-info waves-effect waves-light">Agregar nuevo</button>
        </div>
      </form>
    </div>
  </div>
