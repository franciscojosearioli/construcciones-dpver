...
<div class="modal fade" id="add_laboratorio_asfalto" tabindex="-1" role="dialog" aria-labelledby="add_laboratorio_asfalto" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title w-100" id="add_laboratorio_asfalto">Cargar ensayo de asfalto</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="obra.php?id=<?php echo $obra['idobras']; ?>" name="form_laboratorio_asfalto" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="card-body">
            <div class="form-group p-20">
                                        <div class="row p-t-20 justify-content-center">
                                          <h5><b>Ensayo de asfalto</b></h5>
                                        </div>
        ...
        <div class="modal-footer">
          <button type="submit" name="add_laboratorio_asfalto" class="btn btn-info waves-effect waves-light">Agregar nuevo</button>
        </div>
      </form>
    </div>
  </div>
