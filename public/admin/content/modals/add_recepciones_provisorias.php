<?php $date = make_date(); ?>
<div class="modal fade" id="add_recepcion_provisoria" tabindex="-1" role="dialog" aria-labelledby="add_recepcion_provisoria" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title w-100" id="add_recepcion_provisoria">Agregar recepcion provisoria</h4>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="card-body">
            <form method="post" action="recepciones-provisorias">
...
<div class="modal-footer">
  <button type="submit" name="add_recepcion_provisoria" class="btn btn-info waves-effect waves-light">Guardar cambios</button>
</form>
</div>
</div>
</div>
