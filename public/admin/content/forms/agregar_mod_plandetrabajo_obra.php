...
<div class="row form-center hide" id="agregar_mod_planesdetrabajo">
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            <div>
                                                <h3 class="card-title">Agregar nueva modificacion plan de trabajo y curva</h3>
                                            </div>
                                            <div class="ml-auto">
          ...
          <div class="card-body">
            <form method="post" action="mod-planesdetrabajo" id="form_agregar" enctype="multipart/form-data">
              <div class="row">
                    ...
                    <div class="form-group p-r-10 p-l-10">
                      ...
                      <input type="text" name="agregar_mod_planesdetrabajo" hidden>
                  ...
                  <option selected disabled>Seleccione un estado</option>
                    ...
                    <div id="select-planes-de-trabajo2"></div>
                    </div>
                  </div>
</div>
...
$("#select-planes-de-trabajo2").html(result);
