...
$user = current_user();
$oyp = all_oyp();
$obra = find_by_id("obras","idobras",$_GET['id']);
?>

<div class="row form-center hide" id="agregar_ampliacion">
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            <div>
                                                <h3 class="card-title">Agregar nueva ampliacion</h3>
                                            </div>
                                            <div class="ml-auto">
          ...
          <div class="card-body">
            <form method="post" action="obra.php?id=<?php echo $_GET['idobras']; ?>" id="form_agregar" enctype="multipart/form-data">
              <div class="row">
                    ...
                    <div class="form-group p-r-10 p-l-10">
                      ...
                      <input type="text" name="agregar_ampliacion" hidden>
                ...
                <div class="form-group p-r-10 p-l-10">
                    ...
                    <div class="row p-t-20">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input type="text" name="plazo_tramite" class="form-control" required>
                          </div>
                        </div> 
                        <div class="col-lg-6 col-md-6 col-sm-12">
                          <div class="md-form form-md">
                            <label class="control-label">Plazo final</label>
                          <input type="text" name="plazo_final" class="form-control" required>
                          </div>
                        </div> 
                      </div>
                  </div>      
