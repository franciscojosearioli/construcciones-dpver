...
$direcciones = find_all('direcciones'); ?>
      <div class="row form-center hide" id="agregar_departamentos">
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            <div>
                                                <h3 class="card-title">Agregar nuevo departamento</h3>
          ...
          <div class="card-body">
            <form method="post" action="departamentos" id="form_agregar">
              <div class="row">
                    ...
                    <div class="form-group p-r-10 p-l-10">
                      ...
                      <input type="text" name="add_departamento" hidden>
                  ...
                  <div class="row p-t-20">
                    <div class="col-md-12">
                      <div class="md-form form-md">
                        ...
                        <select class="form-control custom-select" name="iddireccion">
