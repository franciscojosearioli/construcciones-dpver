...
$user = current_user();
$oyp = all_oyp();
$data = find_by_id('obras_ampliaciones','idampliaciones',$_POST['id']);
$obra = find_by_id('obras','idobras',$data['idobras']);

?>

<div class="row form-center" id="editar_ampliaciones">
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            <div>
                                                <h3 class="card-title">Editar ampliacion</h3>
                                            </div>
                                            <div class="ml-auto">
          ...
          <div class="card-body">
            <form method="post" action="ampliaciones" id="form_editar_ampliacion" enctype="multipart/form-data">
              <div class="row">
                    ...
                    <div class="form-group p-r-10 p-l-10">
                      ...
                      <input type="text" name="editar_ampliacion" value="<?php echo $data['idampliaciones']; ?>" hidden>
...
<div class="row">
  ...
  <?php if(!empty($data['resolucion_archivo'])){ ?> data-default-file="<?php echo '../../../uploads/Obras/'.$obra['idobras'].'/Tramites/Ampliaciones/'.$data['numero'].'/Resolucion/'.$data['resolucion_archivo']; ?>" <?php } ?> />
                        </div> 
                      </div>
                  </div>
                </div>
                ...
                <div class="form-group p-r-10 p-l-10">
                    ...
                    <div class="row p-t-20">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input type="text" name="plazo_tramite" class="form-control" value="<?php echo $data['plazo']; ?>" required>
                          </div>
                        </div> 
                        <div class="col-lg-6 col-md-6 col-sm-12">
                          <div class="md-form form-md">
                            <label class="control-label">Plazo final</label>
                          <input type="text" name="plazo_final" class="form-control" value="<?php echo $data['plazo_final']; ?>" required>
                          </div>
                        </div> 
                      </div>
                  </div>      
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <div class="ml-auto">
                                                <ul class="list-inline">
                                                    <li>
                                                        <h6 class="text-muted"><a onclick="submit_editar_ampliacion();" class="dropdown-item a-icon" data-toggle="tooltip" title="Confirmar"><i class="fas fa-check fa-2x"></i></a></h6> 
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
