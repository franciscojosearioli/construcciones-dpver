...
<div class="row justify-content-center">
  <div class="col-10">
    <div class="card">
      ...
      <div class="card-body">
        <form method="post" action="planes-de-trabajo" id="form_editar">
              ...
              <div class="form-group p-r-10 p-l-10">
                ...
                <div class="row p-t-20">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-12">
                    ...
                    <?php 
                    if($plan['referencia'] == NULL){ echo '<option selected disabled>Sin seleccionar</option>'; }
...
<?php foreach ($planoficial_obras as $fila): ?>
          ...
          <?php } ?>
            ...
            <td ><input type="text" class="form-control" name="monto[]" value="<?php echo $fila['monto']; ?>"></td>
            <td><input type="text" class="form-control" name="avance[]" value="<?php echo $fila['avance']; ?>"></td>
          </tr>
        <?php endforeach; ?>
<?php } ?>
 </tbody>
