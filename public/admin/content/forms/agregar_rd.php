      <div class="row form-center hide" id="agregar_rd">
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            <div>
                                                <h3 class="card-title">Agregar nueva recepcion definitiva</h3>
          ...
          <div class="card-body">
            <form method="post" action="recepciones-definitivas" id="form_agregar">
                ...
                <div class="vtabs">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane p-l-20 active" id="tramite" role="tabpanel" aria-expanded="true">
                      <input type="text" name="add_recepcion_definitiva" hidden>
