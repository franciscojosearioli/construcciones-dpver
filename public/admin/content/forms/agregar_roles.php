      <div class="row form-center hide" id="agregar_roles">
        <div class="col-lg-12 col-md-12">
          ...
          <div class="card-body">
            <form method="post" action="usuarios-roles" id="form_agregar">
              <div class="row">
                    ...
                    <div class="form-group p-r-10 p-l-10">
                      ...
                      <input type="text" name="add_rol" hidden>
                      ...
                      <input type="number" id="nivel" name="nivel" class="form-control" required>
                          </div>
                        </div> 
                      </div>
                    </div>
