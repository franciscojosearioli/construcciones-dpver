...
$user = current_user();
$oyp = all_oyp();
$data = find_by_id('obras_neutralizaciones','idneutralizaciones',$_POST['id']);
$obra = find_by_id('obras','idobras',$data['idobras']);
?>

<div class="row form-center" id="editar_neutralizaciones">
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            <div>
                                                <h3 class="card-title">Editar neutralizacion</h3>
                                            </div>
                                            <div class="ml-auto">
          ...
          <div class="card-body">
            <form method="post" action="neutralizaciones" id="form_editar_neutralizacion" enctype="multipart/form-data">
              <div class="row">
                    ...
                    <div class="form-group p-r-10 p-l-10">
                      ...
                      <input type="text" name="editar_neutralizacion" value="<?php echo $data['idneutralizaciones']; ?>" hidden>
...
<div class="row">
  ...
  <?php if(!empty($data['resolucion_archivo'])){ ?> data-default-file="<?php echo '../../../uploads/Obras/'.$obra['idobras'].'/Tramites/Neutralizaciones/'.$data['numero'].'/Resolucion/'.$data['resolucion_archivo']; ?>" <?php } ?> />
                        </div> 
                      </div>
                  </div>
                </div>
                ...
                <div class="form-group p-r-10 p-l-10">
                    ...
                    <div class="row p-t-20">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                          ...
                          <input type="date" name="fecha_reinicio" class="form-control" value="<?php echo $data['fecha_reinicio']; ?>">
                          </div>
                        </div> 
                      </div>
                  </div> 
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <div class="ml-auto">
                                                <ul class="list-inline">
                                                    <li>
                                                        <h6 class="text-muted"><a onclick="submit_editar_neutralizacion();" class="dropdown-item a-icon" data-toggle="tooltip" title="Confirmar"><i class="fas fa-check fa-2x"></i></a></h6> 
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
