...
$user = current_user();
$nota = find_by_id('tramites','idtramites',$_POST['id']); 
...
?>
      <div class="row form-center" id="editar_notas">
            ...
            <div class="card-body">
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            <div>
                                                <h3 class="card-title">Editar datos de nota</h3>
                                                </div>
                                            <div class="ml-auto">
            ...
            <form method="post" action="tramites" id="form_editar">
              <div class="row">
                    ...
                    <div class="form-group p-r-10 p-l-10">
                      ...
                      <input type="text" name="editar_nota" value="<?php echo $nota['idtramites'] ?>" hidden>
                      <div class="row p-t-20">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <div class="md-form form-md">
                            <label class="control-label">Numero / Referencia</label>
                            <input type="text" name="numero" class="form-control" value="<?php echo $nota['numero'] ?>" required>
                          </div>
                        </div> 
                      </div>
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="md-form form-md">
                          ...
                          <input type="text" name="asunto" class="form-control" value="<?php echo $nota['asunto'] ?>" required>
                        </div>
                      </div> 
                    </div>
                      <div class="row p-t-10">
                      <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="md-form form-md">
                          ...
                          <input type="text" name="iniciador" class="form-control" value="<?php echo $nota['iniciador'] ?>" required>
                        </div>
                      </div> 
                    </div>
                      <div class="row p-t-10">
                      <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="md-form form-md">
                          ...
                          <input type="date" name="fecha_inicio" class="form-control" value="<?php echo $nota['fecha_inicio'] ?>" required>
                        </div>
                      </div>
                      </div> 
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="md-form form-md">
                          <label class="control-label">Borrar nota</label><br />
                          <a class="btn btn-sm btn-danger text-white" onclick="eliminar_nota(<?php echo $nota['idnotas']; ?>)" data-toggle="tooltip" title="Eliminar">Confirmar y eliminar</a>
                        </div>
                      </div> 
                    </div>
                    </div>
                    ...
                    <div class="md-form form-md">
                      ...
                      <select class="form-control custom-select" name="prioridad" required>
                        <optgroup label="Establecido">
                          <?php
                          if($nota['prioridad'] == 1){ echo '<option value="1" selected>Urgente</option>';} 
                          if($nota['prioridad'] == 2){ echo '<option value="2" selected>Alto</option>';} 
                          if($nota['prioridad'] == 3){ echo '<option value="3" selected>Medio</option>';} 
                          if($nota['prioridad'] == 4){ echo '<option value="4" selected>Bajo</option>';} 
                          ?>
                        </optgroup>
                  ...
                  <div class="col-md-12">
                    <div class="md-form form-md">
                      ...
                      <select class="form-control custom-select" name="condicion" required>
                        <optgroup label="Establecido">
                          <?php
                          if($nota['condicion'] == 1){ echo '<option value="1" selected>Activo</option>';} 
                          if($nota['condicion'] == 0){ echo '<option value="0" selected>Archivado</option>';} 
                          ?> 
                        </optgroup>
                        <optgroup label="Opciones ">
                ...
                <div class="row p-t-20">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="md-form form-md">
                      ...
                      <textarea name="observaciones" class="form-control md-textarea" rows="2"><?php echo $data["observaciones"]; ?></textarea>
                    </div>
                  </div>
                </div>
                  </div>
