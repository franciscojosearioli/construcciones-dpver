...
?>
      <div class="row form-center hide" id="memo_egreso">
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            <div>
                                                <h3 class="card-title">Nuevo Memorandum de Egreso</h3>
                                                </div>
                                            <div class="ml-auto">
          ...
          <div class="card-body">
            <form method="post" action="memorandums" id="form_agregar_egreso">
              <div class="row">
                    ...
                    <div class="form-group p-r-10 p-l-10">
                      ...
                      <input type="text" name="memo_egreso" hidden>
                    ...
                    <div class="row p-t-20">
                      <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="md-form form-md">
                          <label class="control-label">Fecha de omision</label>
              ...
              <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <div class="ml-auto">
                                                <ul class="list-inline">
                                                    <li>
                                                        <h6 class="text-muted"><a onclick="submit_agregar_egreso()" class="dropdown-item a-icon" data-toggle="tooltip" title="Confirmar"><i class="fas fa-check fa-2x"></i></a></h6> 
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
