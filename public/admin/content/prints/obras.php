...
require_once('../../includes/load.php');
  $results =  obras_construcciones_ejecucion();
  $total = conteo_obras_ejecutadas('obras','idobras');
...
<div class="col-md-12">
  <center>
    <b>
      <h4>Planillas de obras: Todas</h4>
    </b>
  </center>
</div>
<br>
      ...
      <table class="table table-border" width="100%">
        <thead>
          <tr>
              ...
              <th class="theader" style="font-size:70%;" width="10%">Estado</th>
          </tr>
        </thead>
        <tbody>
        ...
        <?php endforeach; ?>
          ...
          <tfoot>
            ...
            <td colspan="2"><b>Total: <?php if($total['total'] > '1'){ echo $total['total'].' Obras'; }else{ echo $total['total'].' Obra'; } ?></b> </td>
            <td colspan="1" style="text-align:right;">Total:</td>
            <td colspan="2" > <?php echo '$ '.numero($total_monto_actualizado['total']);?></td>
            <td colspan="1" style="text-align:left;"></td>
            <td colspan="1" style="text-align:right;">Total:</td>
            <td colspan="3" style="text-align:left;"><?php echo '$ '.numero($total_monto_ejecutado['total']);?></td>
          </tr>
        </tfoot>
      </table>
  </div>
