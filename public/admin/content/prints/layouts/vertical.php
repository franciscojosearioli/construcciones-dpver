...
<head>
  ...
  <link rel="stylesheet" href="../../includes/assets/css/prints/vertical-style.css" />   
  <link rel="stylesheet" href="../../includes/assets/css/prints/vertical-print.css" media="print" />   
</head>
<body>
  <div class="hocultar">
      ...
      <div class="row">
        <div class="col-12">
          <center>
            ...
            <br><br>
            <a onclick="window.print();" style="color:blue;font-weight: 700px;font-size: 20px;border:1px solid #000;padding:10px;">HAGA CLICK AQUI PARA IMPRIMIR O DESCARGAR</a>
          </center>
        </div> 
      </div>
    </div>
