...
$recepcion_obra = recepciones_obra($obra['idobras']);
$fecha = make_date();
cabecera_print_vertical('Informe-'.$obra['idobras'].'-'.$fecha);
?>
<div class="row">
<div class="col-md-12">
  <center>
...
if($modificacion['resolucion_fecha'] != '0000-00-00'){ echo ' el '.$modificacion['resolucion_fecha'];} ?><br />
...
<?php if(ifexist($ampliacion['expediente'])){ echo '<b>Ubicacion del tramite:</b> '.format_date($ul_mov_exp['fecha']); ?> en <b><?php echo utf8_encode($ul_mov_exp['tramite']); }?></b><br />
<?php if(ifexist($ampliacion['resolucion_numero'])){ echo 'Resolucion N° '.$ampliacion['resolucion_numero'];}
if($ampliacion['resolucion_fecha'] != '0000-00-00'){ echo ' el '.$ampliacion['resolucion_fecha'];} ?><br />
...
if($neutralizacion['resolucion_fecha'] != '0000-00-00'){ echo ' el '.$neutralizacion['resolucion_fecha'];} ?><br />
...
echo 'Definitiva'; 
  ...
  </center><u>Nº expediente:</u> <?php echo $rp['expediente']; ?><br/>

<u>Integrantes de comision:</u> <?php 
if(!empty($rp['agente1'])){ echo $rp['agente1'].'<br>';} 
if(!empty($rp['agente2'])){ echo $rp['agente2'].'<br>';} 
if(!empty($rp['agente3'])){ echo $rp['agente3'].'<br>';} 
if(!empty($rp['agente4'])){ echo $rp['agente4']; } ?>
<br/>
</p>
</div>
</div></div>
