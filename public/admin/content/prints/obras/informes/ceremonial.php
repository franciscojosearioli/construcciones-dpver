...
$fecha = make_date();
cabecera_print_vertical('Informe_Ceremonial-'.$obra['idobras'].'-'.$fecha);
if($obra['estado'] == 1){ ?>
<!-- PROYECTO -->
<div class="row">
<div class="col-md-12">
...
<b>Inversion total:</b> 
<?php if(!empty($obra['monto_redeterminado'])){ echo '$ '.numero($obra['monto_redeterminado']);} else { echo '$ '.numero($obra['monto_vigente']); } ?><br />
<b>Plazo de obra:</b> 
