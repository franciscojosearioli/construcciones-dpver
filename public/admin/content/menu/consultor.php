...
<li><a class="menu-subitem waves-effect waves-dark" href="mapa" aria-expanded="false" id="log-menu" onClick="save_log()" data-log-user="Click menu: Mapa">Mapa de obras</a></li>
...
<a class="menu-subitem has-arrow waves-effect waves-dark" href="#" aria-expanded="false">Mesa de entrada</a>
    <ul aria-expanded="false" class="collapse">
        ...
        <li><a href="notas" id="log-menu" onClick="save_log()" data-log-user="Click menu: Notas"><i class="mdi mdi-chevron-right"></i> Notas</a></li>
    </ul>
    </li>
