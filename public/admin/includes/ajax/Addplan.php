...
<tr>
           <td></td><td style="width: 30%">
            ...
            <input type="number" class="form-control" step="any" name="numero[]"></td>
            <td style="width: 40%"><input type="text" step="any" class="form-control" name="monto[]"></td>
            <td style="width: 30%"><input type="text" step="any" class="form-control" name="avance[]"></td>
          </tr>